      ...
      <ul className="highlighted-tld-cards space-y-1 m-0 list-none flex flex-col md:flex-row md:space-x-6">
        {tlds.map((tld) => {
          return (
            ...
            >
              <h4 className="text-5xl font-bold tracking-tight text-gray-900">
                <span className="red-dot text-red-600 mr-1">.</span>me
              </h4>
              <p className="tld-desc text-gray-500">
                The perfect place to showcase who you are and what you're all
                about.
              </p>
              <p className="starting-price text-xl text-gray-700">
                Starting at $3.99/first year*
              </p>
