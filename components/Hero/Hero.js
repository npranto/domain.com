  ...
  return (
    <section className={styles.container}>
      <div className={styles.intro}>
        <h1 className="text-5xl tracking-tight font-black sm:text-5xl md:text-6xl uppercase text-center mb-10 text-white">
        ...
        <form className={styles["search-form"]}>
          ...
          <button
            type="submit"
            className="flex text-sm justify-center align-center py-4 px-2 uppercase bg-red-500 text-white text-center rounded-md mb-3"
          >
            Search
          </button>
        </form>

        <p className="tld-price-info space-x-2 text-center text-sm text-white">
          <span>
